...
export const UserInfoCard: React.FC<UserInfoCardProps> = ({
  ...
  // ✅ Normalize connection status (empty => "Offline")
  const connectionStatus = userInfo.connectionStatus?.trim() || 'Offline';
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md h-full flex flex-col">
      ...
      <div className="space-y-1 flex-grow">
        ...
        <UserInfoRow
          label="Expires On"
          value={new Date(userInfo.expiryDate.replace(/-/g, ' ')).toLocaleDateString()}
        />
        <UserInfoRow
          label="Days Left"
          value={
      ...
      <div className="space-y-1">
        ...
        <UserInfoRow label="Connection" value={<StatusBadge status={connectionStatus} />} />
